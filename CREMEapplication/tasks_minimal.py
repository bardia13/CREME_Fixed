...
from CREME_backend_execution.classes.CREME_Minimal import CremeMinimal
...
def create_creme_object():
    ...
    CremeMinimal.models_name = models_name[:]
    creme = CremeMinimal(dls, target_server, benign_server, vulnerable_clients, non_vulnerable_clients, attacker_server,
